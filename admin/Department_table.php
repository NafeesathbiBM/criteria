      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Department</li>
          </ol>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="d-flex justify-content-between">
              ...
              <a class="btn bg-gradient-dark mb-0" href="Department_details.php"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add</a>
              </div>
            </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <h6 class="mb-0 text-sm"><?php echo $row["DName"]?></h6>
                        </div>
                        </div>
                      </td>
                      <td>
